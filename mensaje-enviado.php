...
<head>
    ...
    <meta property="og:site_name" content="La Torre Roja Producciones" />
    <meta property="og:description" content="Bienvenido a La Torre Roja Producciones - Creatividad efectiva aplicada" />
    <meta name="twitter:title" content="La Torre Roja Producciones" />
    <meta name="twitter:image" content="https://latorrerojaproducciones.com/" />
    <meta name="twitter:url" content="https://latorrerojaproducciones.com/" />
    <meta name="twitter:card" content="Bienvenido a La Torre Roja Producciones - Contacto" />
        ...
        <div class="mil-preloader">
            <div class="mil-preloader-animation">
                <div class="mil-pos-abs mil-animation-1">
                    <p class="mil-h3 mil-muted mil-thin">Conceptos</p>
                    <p class="mil-h3 mil-muted">creativos</p>
                    <p class="mil-h3 mil-muted mil-thin">eficaces</p>
                </div>
                <div class="mil-pos-abs mil-animation-2">
                    <div class="mil-reveal-frame">
                        <p class="mil-reveal-box"></p>
                        <p class="mil-h3 mil-muted mil-thin">latorrerojaproducciones.com</p>
                    </div>
                </div>
            </div>
        </div>
    -->
        ...
        <div class="mil-menu-frame">
            ...
            <div class="mil-frame-top">
                <a href="./" class="mil-logo"><img src="./img/logos/favicon.png" height="50"></a>
                            ...
                            <nav class="mil-main-menu" id="swupMenu">
                                <ul>
                                    ...
                                    <li class="mil-has-children">
                                        <a href="#.">Servicios</a>
                                        <ul>
                                            <li><a href="service-1.html">Branding e Identidad de marca</a></li>
                                            <li><a href="service-2.html">Diseño y Desarrollo web</a></li>
                                            <li><a href="service-3.html">Diseño editorial y de publicaciones</a></li>
                                            <li><a href="service-4.html">Consultoría creativa y desarrollo de
                                                    conceptos</a></li>
                                        </ul>
                                    </li>
                                    <li class="mil-has-children">
        ...
        <div class="mil-frame">
            <div class="mil-frame-top">
                <a href="./" class="mil-logo"><img src="./img/logos/favicon.png" alt="" height="50"></a>
                <div class="mil-menu-btn">
                    <span></span>
                </div>
            </div>
            ...
            <div id="swupMain" class="mil-main-transition">
                ...
                <div class="mil-map-frame mil-up">
                    <div class="mil-map">
                        ...
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d3762.532024051841!2d-99.13577627455018!3d19.432615681846787!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1ses!2smx!4v1765851386641!5m2!1ses!2smx"
                        ...
                        <div class="container mil-p-120-60">
                            <div class="row justify-content-between">
                                <div class="col-md-4 col-lg-4 mil-mb-60">
                                    ...
                                    <div class="mil-muted mil-logo mil-up mil-mb-20">LaTorreRoja Producciones.</div>
                                    <p class="mil-light-soft mil-up mil-mb-30">Tenemos algo que contarte...</p>
                                    ...
                                    <div class="row justify-content-end">
                                        <div class="col-md-6 col-lg-7">
                                            ...
                                            <nav class="mil-footer-menu mil-mb-60">
                                                <ul>
                                                    ...
                                                    <li class="mil-up">
                                                        <a data-no-swup href="./index.html#quehacemos">Servicios</a>
                                                    </li>
                                                    <li class="mil-up">
                                                        <a href="#">Contacto</a>
                                                    </li>
                                                    <li class="mil-up">
                                                        <a data-no-swup href="./index.html#anchor-blog">Blog</a>
                                                    </li>
                                                </ul>
                                            </nav>
                                        ...
                                        <div class="col-md-6 col-lg-5">
                                            ...
                                            <ul class="mil-menu-list mil-up mil-mb-60">
                                                <li><a href="#." class="mil-light-soft">Políticas de privacidad</a></li>
                                                <li><a href="#." class="mil-light-soft">Políticas de cookies</a></li>
                                            </ul>
                                    ...
                                    <div class="mil-vert-between">
                                        <div class="mil-mb-30">
                                            <ul class="mil-social-icons mil-up">
                                                <li><a data-no-swup
                                                        href="https://www.instagram.com/latorrerojaproducciones/"
                                                        target="_blank" class="social-icon"> <i
                                                            class="fa-brands fa-instagram"></i></a></li>
                                                <li><a data-no-swup href="mailto:info@latorrerojaproducciones.com"
                                                        target="_blank" class="social-icon"> <i
                                                            class="fa-solid fa-envelope"></i></a></li>
                                                <li><a data-no-swup
                                                        href="https://www.facebook.com/latorrerojaproducciones"
                                                        target="_blank" class="social-icon"> <i
                                                            class="fa-brands fa-facebook"></i></a></li>
                                                <!--<li><a href="#." target="_blank" class="social-icon"> <i class="fa-brands fa-behance"></i></a></li>-->
                                            </ul>
                                        </div>
                                        <p class="mil-light-soft mil-up">© Copyright 2026 - LaTorreRoja Producciones.
